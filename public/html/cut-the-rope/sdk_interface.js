      ...
      return new Promise(function (resolve, reject) {
        switch (event) {
          ...
          case "EVENT_RESUME":
            ...
            break;
          case "EVENT_CUSTOM":
            if (params.eventName === "EVENT_TUTORIAL") {
              tutorial = true;
            }
            break;
...
const SDK_INTERFACE_BANNER = function () {
  /* Create banner */
  let config =
    SDK_INTERFACE_CUSTOM_SETTINGS.bannerConfig[famobi.getOrientation()];
...
const SDK_INTERFACE_BANNER_AD = function (hideAfterCreation = true) {
  return new Promise(function (resolve, reject) {
    ...
    if (
      Date.now() / 1000 - SDK_INTERFACE_CUSTOM_SETTINGS.lastRefresh <
      SDK_INTERFACE_CUSTOM_SETTINGS.interval
    ) {
