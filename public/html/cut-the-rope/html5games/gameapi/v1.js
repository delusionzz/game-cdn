!(function (a, b) {
  const SDK_INTERFACE = {
    ...
    preload: function (type) {
      ...
      if (
        this.settings[type].attempts > 0 &&
        this.settings[type].fails >= this.settings[type].attempts
      ) {
        return;
      }
      ...
      window.famobi_adapters = {
        api: {
          created: function () {
            ...
            window.famobi.adapters.add(
              "viewport",
              "offsetChanged",
              (offsets) => {
                if (
                  typeof window.famobi.onOffsetChangeCallback === "function"
                ) {
